...
public class SaltyJunkFood extends AppCompatActivity {
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salty_junk_food);
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.optNotes) {
                    Toast.makeText(SaltyJunkFood.this, "This app is still in development. Hope you like it!", Toast.LENGTH_LONG).show();
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SaltyJunkFood.this, PotatoChips.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SaltyJunkFood.this, Biscuits.class);
                startActivity(intent);
            }
        });
